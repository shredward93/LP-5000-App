...
A user interface for custom templates used with the opensource Claude Code extension, [ButterCut](https://github.com/barefootford/buttercut). Use this folder as your project root so the engine can route media, sync multicam, and generate edit XMLs correctly.
...
This quick start assumes that you've already installed Claude Code and the ButterCut extension. If you haven't already done so, follow these documents to install [Claude Code](https://code.claude.com/docs/en/quickstart) and [ButterCut](https://buttercut.io/#install).
